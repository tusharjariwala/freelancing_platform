		...
		<div class="col-xl-9 col-lg-8 content-left-offset">
			...
			<div class="tasks-list-container margin-top-35">
				...
				<a href="" class="task-listing">
				 ...
				 <a class="button button-sliding-icon ripple-effect" href="<?php echo site_url('Displayproject/loadBidById/'.$p->ProjectId)?>">Bid Now<i class="icon-material-outline-arrow-right-alt"></i></a><br>
				<!--  <a class="button button-sliding-icon ripple-effect" href="<?php echo site_url("Displayproject/loadEditProject/".$p->ProjectId)?>">Update Project<i class="icon-material-outline-arrow-right-alt"></i></a>  -->
