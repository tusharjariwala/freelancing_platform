...
<div class="container">
	<div class="row">
		...
		<div class="col-xl-9 col-lg-8 content-left-offset">
			...
			<h3 class="page-title">Complain</h3>
			...
			<div class="freelancers-container freelancers-list-layout margin-top-35">
				...
				<div class="freelancer">
					...
					<div class="bidding-widget">
						...
						<div class="bidding-headline"><h3>Enter your Complain</h3></div>
					 ...
					 <div class="feedback-yes-no">
						<strong>Your Complain</strong>
							...
							<form method="post" action="<?php echo site_url('Displayproject/addComplaint/'.$uid.'/'.$pid)?>">
								...
								<textarea class="with-border" placeholder="Enter your Message!!" name="txtMessage" id="" cols="7" required></textarea>
