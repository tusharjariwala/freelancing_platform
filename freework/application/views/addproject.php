...
<!-- Mirrored from www.vasterad.com/themes/hireo/dashboard-post-a-job.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 May 2021 08:53:32 GMT -->
<head>
...
<div class="dashboard-container">
				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Start">
							<li><a href="<?php echo site_url("Displayproject/loadProject")?>"><i class="icon-material-outline-dashboard"></i> Project</a></li>
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			<form method="post" action="<?php echo site_url("Project/addProject")?>" enctype="multipart/form-data">
			<!-- Dashboard Headline -->
			...
			<div class="row">
							...
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Project Title</h5>
										<input type="text" class="with-border" name="txttitle">
									</div>
								</div>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<select class="form-control" data-size="7" title="Select Category" name="txtCat" id="" onchange="loadSubCats(this.value)">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Project SubCategory</h5>
									<select class="form-control"  title="Select SubCategory" id="subCat" name="txtSubCat" onchange="loadSkills(this.value)">
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="input-with-icon">
													<input class="with-border" type="text" placeholder="budget" name="txtprice">
													<i class="currency">RS</i>
												</div>
											</div>
											<!-- <div class="col-xl-6">
												<div class="input-with-icon">
													<input class="with-border" type="text" placeholder="Max" txtprice>
								...
								<div class="col-xl-0.1">
									<div class="submit-field">
										
										<h5>select Skills if Any</h5>
										<div id="skills">
								...
								<div class="col-xl-12">
									<div class="submit-field">
										...
										<textarea cols="30" rows="5" class="with-border" name="txtdesc"></textarea>
										<div class="uploadButton margin-top-30">
											<input class="uploadButton-input" type="file" accept="image/*, application/pdf" id="upload" name="fup" multiple/>
                                ...
                                <div class="col-xl-0.1">
									<!-- <div class="submit-field">
										<h5>Starting Date</h5>
										<input type="Date" name="txtstarting">
								 ...
								 <div class="col-xl-0.1">
									<!-- <div class="submit-field">
										<h5>Ending Date</h5>
										<input type="Date" name="txtending">
				...
				<div class="col-xl-12">
			  <button value="submit" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Post a Project
		  </button>
				</div>
...
<script src="<?php echo base_url('resources/user/')?>js/chart.min.js"></script>
<script>
...
<script src="<?php echo base_url('resources/user/')?>https://maps.googleapis.com/maps/api/js?key=AIzaSyAaoOT9ioUE4SA8h-anaFyU4K63a7H-7bc&amp;libraries=places"></script>
