...
<div class="container">
	<div class="row">
		...
		<div class="col-xl-9 col-lg-8 content-left-offset">
			...
			<h3 class="page-title">Approval Project</h3>
			...
			<div class="freelancers-container freelancers-list-layout margin-top-35">
				...
				<div class="freelancer">
					...
					<div class="bidding-widget">
						...
						<div class="bidding-headline"><h3>Approval  on this Project!</h3></div>
						<div class="bidding-inner">
							...
							<input class="bidding-slider" type="text" value="" data-slider-handle="custom" data-slider-currency="$" data-slider-min="2500" data-slider-max="4500" data-slider-value="auto" data-slider-step="50" data-slider-tooltip="hide" name="txtbudget"/>
							<!-- Headline -->
							...
							<div class="bidding-fields">
                             ...
                             <!--    <?php echo $Project->CreateDate?> -->
								...
								<button id="snackbar-place-bid" class="button ripple-effect move-on-hover full-width margin-top-30" ><span>Approval Project</span>
								</button>
							</div><br>
						</div>
